...
public class MainTagalogRev extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tagalog_rev);
        ...
        Reviewertraffic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( MainTagalogRev.this , Reviewertagalog.class);
                startActivity(intent);

                if (mInterstitialAd != null) {
                    mInterstitialAd.show(MainTagalogRev.this);
                } else {
        ...
        Examtraffics.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent( MainTagalogRev.this , Examtagalog.class);
                startActivity(intent);
        ...
        Button tagalogexam = (Button) findViewById(R.id.Exam); // creating a CardView and assigning a value.
        tagalogexam.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( MainTagalogRev.this , Examtagalog.class);
                startActivity(intent);
    ...
    private void createIntersitialiezed( AdRequest adRequest){
        ...
        InterstitialAd.load(this,"ca-app-pub-4394473472808077/7895561802", adRequest, new InterstitialAdLoadCallback() {
            @Override
